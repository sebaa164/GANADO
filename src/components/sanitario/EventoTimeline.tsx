...
export function EventoTimeline({ eventos, onCerrarTratamiento }: EventoTimelineProps) {
  if (eventos.length === 0) {
    return (
      <div className="text-center py-16 rounded-xl bg-gray-50 border-2 border-dashed border-gray-200 dark:border-gray-700">
        <p className="text-lg font-semibold text-gray-500 dark:text-gray-400">Sin eventos para este filtro</p>
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex flex-wrap items-center gap-2 mb-2">
              <span className="text-base font-bold text-gray-900 dark:text-white">{eventoLabel(evento.tipo)}</span>
