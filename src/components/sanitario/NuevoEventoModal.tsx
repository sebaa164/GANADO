    ...
    <Modal isOpen={isOpen} onClose={handleClose} title="Registrar evento sanitario" className="max-w-lg">
      <div className="space-y-4">
        <div className="flex flex-col gap-1">
          <label className="text-sm font-medium text-gray-700" htmlFor="evento-tipo">Tipo de evento</label>
          <select
            id="evento-tipo"
            value={form.tipo}
        ...
        <div className="flex flex-col gap-1">
          <label className="text-sm font-medium text-gray-700" htmlFor="evento-desc">Descripción</label>
          <textarea
            id="evento-desc"
            rows={3}
        ...
        <div className="flex flex-col gap-1">
          <label className="text-sm font-medium text-gray-700" htmlFor="evento-estado">Estado</label>
          <select
            id="evento-estado"
            value={form.estado}
