...
const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
        <path fillRule="evenodd" d="M12 1.586l-4 4v12.828l4-4V1.586zM3.707 3.293A1 1 0 002 4v10a1 1 0 00.293.707L6 18.414V5.586L3.707 3.293zm14 2L14 7.414v12.828l2.293-2.293A1 1 0 0018 17V7a1 1 0 00-.293-.707z" clipRule="evenodd" />
      </svg>
    ),
  },
  {
